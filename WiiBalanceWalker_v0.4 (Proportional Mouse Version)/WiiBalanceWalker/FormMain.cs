...
namespace WiiBalanceWalker
{
    public partial class FormMain : Form
    {
        ...
        private void InfoUpdate()
        {
            ...
            actionList.Left.xMultiplier = Math.Abs(xPos);
            actionList.Right.xMultiplier = Math.Abs(xPos);
            actionList.Forward.yMultiplier = Math.Abs(yPos);
            actionList.Backward.yMultiplier = Math.Abs(yPos);
